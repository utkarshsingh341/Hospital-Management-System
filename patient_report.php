...
?>
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    <h6 class="border-bottom pb-2 mb-0">Completed Appointments</h6>
    ...
    <table class="table table-striped m-3">
        ...
        <tbody>
            <?php
                $apt_query = mysqli_query($con,"SELECT * FROM appointment WHERE patient_id='$session_id' AND completed='1' ORDER BY id DESC") or die("Could not select Appointment Table");
                while($apt_row = mysqli_fetch_array($apt_query))
                {
                    ...
                    echo '<tr>
                          ...
                          <td>'.$apt_date.'</td>
                          <td><a href="" data-bs-toggle="modal" data-bs-target="#'.$apt_modal.'">View Report</a></td>
                        </tr>
