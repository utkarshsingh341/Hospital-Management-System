...
<div class="container" style="">
  ...
  <div class="card fs-6" style="">
    <div class="card-body">
      ...
      <p class="card-text">You have logged in on this Hospital Management System with the role of an <b>Executive Administrator</b>. You can Review Appointment Requests made by patients, Alter the contents of the Medical Inventory of the hospital.</p>
    </div>
    <div class="card-body">
  ...
  <div class="card fs-6">
    ...
    <div class="card-body">
      <h5 class="card-title">Appointments Review</h5>
      <p class="card-text">Review appointment requests made by the patients. You can choose to accept / decline their requests.</p>
      <a href="#" class="btn btn-primary btn-sm">Review Appointments</a>
    </div>
  </div>

  <div class="card fs-6">
    <div class="card-body">
      <h5 class="card-title">Medical Inventory of the Hospital</h5>
      <p class="card-text">Add medicines with inventory details to the database of the hospital &bull; You can edit / delete these entries.</p>
